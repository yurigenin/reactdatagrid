...
export const CLEAR_ICON = (
  <svg height="10" width="10" viewBox="4 4 16 16">
...
export const CALENDAR_ICON = (
  <svg width="16" height="16" viewBox="0 0 16 16">
    <g fillRule="evenodd">
      ...
      />
      <path d="M11.692 3.077c-.339 0-.615-.276-.615-.615V.615c0-.339.276-.615.615-.615.34 0 .616.276.616.615v1.847c0 .339-.277.615-.616.615z" />
    </g>
  </svg>
);
