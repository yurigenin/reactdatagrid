...
export default class InovuaDataGridHeader extends React.Component {
    constructor(props) {
        ...
        this.onCellUnmount = (cellProps, cell) => {
            // do not consider cells while dragging
            if (cellProps.dragging) {
                return;
            }
        ...
        this.findCellById = (cellId, cellsArray = this.cells) => {
        ...
        this.getGaps = (startIndex, endIndex) => {
        ...
        this.setColumnRenderStartIndex = columnRenderStartIndex => {
        ...
        this.notifyScrollLeftMax = scrollLeftMax => {
        ...
        this.onCellMouseDown = (headerCellProps, event) => {
            if (this.props.onCellMouseDown) {
                this.props.onCellMouseDown(headerCellProps, event);
            }
        };
        this.onCellTouchStart = (headerCellProps, event) => {
        ...
        this.onResizeMouseDown = (groupProps, headerGroupInstance, event) => {
        ...
        this.onResizeTouchStart = (groupProps, headerGroupInstance, event) => {
        ...
        this.getItemsForDepth = (items, depth) => {
        ...
        this.groupItemsForDepth = (items, depth) => {
        ...
        this.renderGroupedCells = cellProps => {
            ...
            const items = cellProps.map((props, index) => {
                ...
                return React.createElement(Cell, Object.assign({}, props, { key: props.id, depth: depth }));
            });
            return this.renderItems(items);
        };
        this.onFilterValueChange = (filterValue, cellProps) => {
